...
### Beginner level
- Day 4: [Rock paper scissors](https://github.com/qilinz/Python-Projects/blob/main/Beginner/Day4-rock-paper-scissors.py). Users can play rock paper scissors game with the computer. (Randomisation, list) 
...
- Day 1: [Band name generator](https://github.com/qilinz/Python-Projects/blob/main/Beginner/Day1-band-name-generator.py). Combine user's inputs of their city and pet name as the brand name.
