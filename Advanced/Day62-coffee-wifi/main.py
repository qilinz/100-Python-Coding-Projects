...
class CafeForm(FlaskForm):
    ...
    open = StringField('Open time (e.g. 11AM)）', validators=[DataRequired()])
    close = StringField('Closing time (e.g. 6:30PM)', validators=[DataRequired()])
    coffee = SelectField(u'Coffee Rating', choices=['☕', '☕☕', '☕☕☕', '☕☕☕☕', '☕☕☕☕☕'])
    wifi = SelectField(u'Wifi Rating', choices=['✘','💪', '💪💪', '💪💪💪', '💪💪💪💪', '💪💪💪💪💪'])
    power = SelectField(u'Power Rating', choices=['🔌', '🔌🔌', '🔌🔌🔌', '🔌🔌🔌🔌', '🔌🔌🔌🔌🔌'])
